...
import personal.nfl.java.demo.asm.Generator;
...
public class HelloGeneratorClass implements Opcodes {
    ...
    private final static String HELLO_CLASS_NAME = "personal/nfl/java/demo/asm/helloaop2/Hello" ;
    ...
    public static byte[] generatorHelloClass() throws Exception {
        ...
        cw.visit(V1_7, ACC_PUBLIC + ACC_SUPER, HELLO_CLASS_NAME ,
...
//            mv.visitLabel(l0);
        ...
        }
        {
            ...
            mv.visitFrame(Opcodes.F_FULL, 8,
                    new Object[]{"personal/nfl/java/demo/asm/helloaop2/Hello", Opcodes.INTEGER, "[Ljava/util/Map;",
            ...
            mv.visitLabel(l2);
            mv.visitFrame(Opcodes.F_FULL, 4, new Object[]{"personal/nfl/java/demo/asm/helloaop2/Hello", Opcodes.INTEGER,
    ...
    public static void main(String[] args) {
        try {
            ...
            Class<?> helloClass = myClassLoader.defineClass("personal.nfl.java.demo.asm.helloaop2.Hello", data);
...
//            System.out.println(method.invoke(obj, "单单"));
            ...
            FileUtil.writeFile(Generator.createClassPath(helloClass) , data);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
